...
const Home = () => {
        ...
        <div>
          <div className='lg:w[570px]'>
            ...
            md:leading-[70px]'>
              ...
              It is in these moments of uncertainity that we discover the true essence of our being and the path we must tread. 
  ...
  <section>
    <div className='container'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-
      ...
      <div className='flex items-center justify-between flex-col lg:flex-row'>
         ...
         <div className='xl:w-[670px]'>
          ...
          <ul className='pl-4'>
            ...
            <li className='text_para'>
              2. Search for your physician here, and contact their offers.
            </li>
            <li className='text_para'>
          ...
          <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
            ...
            [100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
              ...
              <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                ...
                text-headingColor'>Wayne Collins
                </h4>
              </div>
            </div>
          </div>
